...
export const sitePages: Record<string, SitePage> = {
  ...
  "vnd": {
    ...
    panels: [
      { label: "Политики", title: "Основные документы", text: "Внутренние документы, определяющие единые принципы социальной политики Компании" },
      { label: "Регламенты", title: "Порядок работы", text: "Актуальные регламенты, процедуры и требования по направлениям Департамента" },
      { label: "Материалы", title: "Методическая поддержка", text: "Шаблоны, рекомендации и материалы для подразделений и региональных представителей" },
    ],
  },
  "social-stability": {
