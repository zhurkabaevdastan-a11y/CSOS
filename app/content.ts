...
export const sportResults = [
  ...
  { label: "Спартакиада · 2026", title: "XI Спартакиада АО «Самрук-Қазына»", text: "Сборная ҚТЖ завоевала 27 призовых мест: 9 первых, 13 вторых и 5 третьих. Соревнования прошли 8–10 августа 2026 года в Астане." },
