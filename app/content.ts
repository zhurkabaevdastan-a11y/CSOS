...
export const sitePages: Record<string, SitePage> = {
  ...
  "social-stability/srs": {
    ...
    lead: "Исследования социальной стабильности и динамика ключевых показателей за период 2017–2026 годов",
    panels: [
      { label: "Период", title: "2017–2026", text: "Материалы будут систематизированы по годам и доступны в единой хронологии" },
      { label: "Аналитика", title: "Динамика показателей", text: "Сравнение результатов исследований и факторов социального самочувствия работников" },
  ...
  "youth/forum": {
    path: "/youth/forum", title: "Республиканский форум молодёжи", eyebrow: "Диалог нового поколения",
    lead: "Общая площадка молодых работников ҚТЖ для обмена опытом, обсуждения идей и запуска совместных проектов",
    panels: [
      { label: "Диалог", title: "Открытое обсуждение", text: "Встречи с руководителями, экспертами и представителями молодёжных советов" },
      { label: "Опыт", title: "Лучшие практики", text: "Обмен успешными региональными инициативами и работающими форматами" },
      { label: "Проекты", title: "Новые решения", text: "Командная разработка предложений для развития Компании и молодых специалистов" },
    ],
  },
